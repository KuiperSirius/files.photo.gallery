 ! function(e) {
	...
	function c(e, t, i, a) {
		...
		return a && (n = g(n, "span", !1, G("图像尺寸"))), g(n, t, i)
	}
	...
	function r(e, t, i, a) {
		...
		if (!n) return "";
		var o = filesize(n);
		return a && (o = g(o, "span", !1, G("文件大小"))), g(o, t, i)
	}

	function d(e, t, i) {
		return _c.context_menu && e ? '<button class="context-button' + (t ? " " + t : "") + '" data-action="context"' + f(!!i && G("选项")) + ">" + E.get_svg_multi("dots", "minus") + "</button>" : ""
	}
	...
	function X(e, t) {
		...
		function() {
			...
			function l(e, i) {
				return '<li class="crumb"><a href="' + o(e) + '" data-path="' + t(e) + '" class="crumb-link"' + (e ? "" : ' title="' + G("首页") + '"') + ">" + i + "</a></li>"
			}
				...
				if (_c.context_menu) {
					...
					if (d) {
						...
						if (N.contextmenu.item = l || _c["sidebar" === c ? "dirs" : "files"][v], N.contextmenu.item) {
							o.stopPropagation(), (m || u) && (R.contextmenu.innerHTML = '<h6 class="dropdown-header" title="' + t(N.contextmenu.item.basename) + '">' + E.get_svg_file_icon(N.contextmenu.item) + i(N.contextmenu.item.basename) + "</h6>" + e("放大", "zoom_in", "popup", "popup" !== c && N.contextmenu.item.is_browser_image && N.contextmenu.item.is_readable) + e("打开", "folder_open", "folder", "sidebar" !== c && "dir" === N.contextmenu.item.filetype) + e("显示信息", "info", "modal", !["modal", "popup"].includes(c)) + function(e, t, i, a) {
								if (!e) return "";
								var o = n(e);
								return o && "#" !== o ? g(E.get_svg("open_in_new") + U("在新标签页中打开", i), "a", t, U("在新标签页中打开", a), o) : ""
							}(N.contextmenu.item, "dropdown-item", !0) + e("复制链接", "clipboard", "clipboard", W.url && W.clipboard && N.contextmenu.item.url_path) + function(e, t, i, a) {
								return W.download && "dir" !== e.filetype && e.is_readable ? g(E.get_svg("download") + U("下载", i), "a", t, U("下载", a), n(e, !0), !0) : ""
		...
		function() {
			...
			i.innerHTML = '<button type="button" class="btn-icon btn-topbar">' + E.get_svg("layout_" + N.layout.layout) + '</button><div class="dropdown-menu dropdown-menu-right"><h6 class="dropdown-header">' + G("布局") + "</h6>" + M(N.layout.keys, (function(e) {
			...
			})) + '<div class="form-check form-switch cover-toggle">\t  <input class="form-check-input" type="checkbox" id="covertoggle"' + (_c.image_cover ? " checked" : "") + '>\t  <label class="form-check-label" for="covertoggle">' + G("覆盖") + "</label>\t</div></div>";
			var a = i.firstChild,
				n = i.lastChild,
	...
	var Q = {
		...
		sh: "application/x-sh",
		bat: "application/x-sh",
		cmd: "application/x-sh",
	...
	function $() {
			...
			E.popup_transition = function(e) {
				...
				N.popup.is_playing = !N.popup.is_playing, w.classList.toggle("is-playing", N.popup.is_playing), W.is_pointer && (w.dataset.tooltip = G(N.popup.is_playing ? "暂停" : "播放")), N.popup.is_playing || p(), N.popup.is_playing && u()
		...
		function() {
			...
			i.innerHTML = '<button type="button" class="btn-icon btn-topbar">' + E.get_svg("sort_" + N.sort.sort) + '</button><div class="dropdown-menu dropdown-menu-right"><h6 class="dropdown-header">' + G("分类") + "</h6>" + M(N.sort.keys, (function(e) {
		...
		function() {
			...
			screenfull.isEnabled ? (i.innerHTML = E.get_svg_multi("expand", "collapse"), i.dataset.tooltip = G("全屏窗口"), i.classList.add("tooltip-left", "tooltip-bottom"), i.addEventListener("click", (function() {
				screenfull.toggle()
